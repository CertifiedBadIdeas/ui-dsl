...
private fun StringBuilder.appendMinecraftHelpers() {
    ...
    appendLine("                val lineWidth = font.width(line)")
    appendLine("                val textX =")
    appendLine("                    when (alignment) {")
    appendLine("                        TextAlignment.Start -> x")
    appendLine("                        TextAlignment.Center -> x + (width - lineWidth) / 2")
    appendLine("                        TextAlignment.End -> x + width - lineWidth")
    appendLine("                    }")
    appendLine("                graphics.drawString(font, line, textX, y + index * lineHeight, color, false)")
    appendLine("            }")
    appendLine("        } finally {")
